...
public class ScoreBoard : IScoreBoard
{
    ...
    private int _currentStuednt = 0; // number of student in file
    ...
    public Boolean ReadFile(string subjectId, string semester)
    {
        try
        {
            using (StreamReader reader = new StreamReader(Path))
            {
                ...
                Course.NameSubject = subjectData[1].Trim();
    ...
    {
        CurrentStudent = _listStudentScores.Count;
        try
        {
            ...
            using (StreamWriter writer = new StreamWriter(stream))
            {
                ...
                writer.WriteLine($"Subject|{Course.NameSubject}");
    ...
    public int AddScoreStudent()
    {
        ...
        if (id != null)
        {
            ...
            else
            {
                ...
                newScore.Id = id;
                newScore.SurAndMiddleName = newsurAndMiddleName;
